---
title: Beryllium Bullet, Point Release
type: release
source_url: https://github.com/monero-project/monero/releases/tag/v0.13.0.4
author: fluffypony
tag_name: v0.13.0.4
published_at: '2018-10-25T10:39:06+00:00'
---
...
- [Windows, 64-bit](https://downloads.getmonero.org/cli/monero-win-x64-v0.13.0.4.zip)
- [Windows, 32-bit](https://downloads.getmonero.org/cli/monero-win-x86-v0.13.0.4.zip)
- [macOS, 64-bit](https://downloads.getmonero.org/cli/monero-mac-x64-v0.13.0.4.tar.bz2)
- [Linux, 64-bit](https://downloads.getmonero.org/cli/monero-linux-x64-v0.13.0.4.tar.bz2)
- [Linux, 32-bit](https://downloads.getmonero.org/cli/monero-linux-x86-v0.13.0.4.tar.bz2)
- [Linux, ARMv7](https://downloads.getmonero.org/cli/monero-linux-armv7-v0.13.0.4.tar.bz2)
- [FreeBSD, 64-bit](https://downloads.getmonero.org/cli/monero-freebsd-x64-v0.13.0.4.tar.bz2)
