---
title: Fluorine Fermi, GUI, Point Release 3.4
type: release
source_url: https://github.com/monero-project/monero-gui/releases/tag/v0.18.3.4
author: binaryFate
tag_name: v0.18.3.4
published_at: '2024-08-22T13:50:06+00:00'
---
...
[The latest CLI release notes and downloads can be found on the release page here.](https://github.com/monero-project/monero/releases/tag/v0.18.3.4)

Some highlights of this release are:

- Add support for Trezor Safe 5 (#4332)
- Enable pruning by default (#4320)
- Allow @ in OpenAlias domain (#4308)
- Fix stagenet restore height estimation (#4310)
- Fix an edge case with desktop entry (#4300)
- Update P2Pool to v4.1 (#4334)
- Update Qt to 5.15.14 (#4321)
