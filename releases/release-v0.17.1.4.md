---
title: Oxygen Orion, GUI, Point Release 1.4
type: release
source_url: https://github.com/monero-project/monero-gui/releases/tag/v0.17.1.4
author: binaryFate
tag_name: v0.17.1.4
published_at: '2020-11-13T10:32:04+00:00'
---
...
This is the v0.17.1.4 minor point release of the Monero GUI software.
This release fixes an issue with the wallet not starting on some Linux systems.

[The latest CLI release notes can be found on the precedent blog post](https://www.getmonero.org/2020/11/08/monero-0.17.1.3-released.html)
