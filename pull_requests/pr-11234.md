...
source_url: https://github.com/monero-project/monero/pull/11234
author: Fennec-tech
assignees: []
labels: []
created_at: '2026-09-03T04:09:13+00:00'
updated_at: '2026-09-04T03:42:15+00:00'
type: pull_request
status: open
closed_at: null
merged_at: null
...
# Discussion History
## munzzyy | 2026-09-03T21:30:01+00:00
In on_make_uri, the destinations-vs-single-address conflict check only looks at req.address and req.amount, not req.payment_id. If a caller passes both destinations (2+) and payment_id, no error is raised, payment_id just never reaches make_uri (that overload doesn't even take a plain payment_id arg) and gets silently dropped from the resulting URI. Is that intended, or should this branch reject a non-empty payment_id the same way it rejects address/amount?

# Action History
- Created by: Fennec-tech | 2026-09-03T04:09:13+00:00
