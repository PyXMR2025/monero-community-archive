...
source_url: https://github.com/monero-project/monero/pull/10165
author: SNeedlewoods
assignees: []
labels:
- wallet
created_at: '2025-10-13T17:15:21+00:00'
updated_at: '2026-05-23T02:05:34+00:00'
type: pull_request
status: merged
closed_at: '2026-05-10T17:40:36+00:00'
merged_at: '2026-05-10T17:40:36+00:00'
---
...
# Discussion History
## selsta | 2026-05-10T01:09:09+00:00
```suggestion
  const uint64_t approximate_rolled_back_blocks = m_nettype == TESTNET ? 26600 : m_nettype == STAGENET ? 48600 : 33600;
```

This already exists in the current code, so it is not a regression from this PR, but I don't think `static` is correct here. While `monero-wallet-cli` has a static nettype, API users can create multiple `WalletImpl` instances with different nettypes.

## rbrunner7 | 2026-05-10T07:57:43+00:00
After checking this, I can confirm: Making such a temporary variable within a single method static makes no sense.

# Action History
- Created by: SNeedlewoods | 2025-10-13T17:15:21+00:00
- Merged at: 2026-05-10T17:40:36+00:00
