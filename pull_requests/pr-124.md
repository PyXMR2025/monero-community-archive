---
title: 'chore(deps): update dependency ffigen to v18'
source_url: https://github.com/MrCyjaneK/monero_c/pull/124
author: renovate[bot]
assignees: []
labels: []
created_at: '2025-03-11T06:53:22+00:00'
updated_at: '2025-04-01T10:04:34+00:00'
type: pull_request
status: merged
closed_at: '2025-03-17T12:23:30+00:00'
merged_at: '2025-03-17T12:23:30+00:00'
---
...
|---|---|---|---|
| [ffigen](https://redirect.github.com/dart-lang/native) ([source](https://redirect.github.com/dart-lang/native/tree/HEAD/pkgs/ffigen)) | dev_dependencies | major | `^14.0.0` -> `^18.0.0` |
...
### [`v18.0.0`](https://redirect.github.com/dart-lang/native/blob/HEAD/pkgs/ffigen/CHANGELOG.md#1800)

[Compare Source](https://redirect.github.com/dart-lang/native/compare/ffigen-v17.0.0...ffigen-v18.0.0)
...
-   **Breaking change**: Change the `usrTypeMappings` field of `Config`'s factory
...
-   **Breaking change**: `keepIsolateAlive` defaults to true, so all existing ObjC
    blocks and protocols now keep their isolates alive by default.
-   Change how protocols are implemented to fix
    [a bug](https://redirect.github.com/dart-lang/http/issues/1702), by removing all uses
    of `NSProxy`.
-   **Breaking change**: Change how duplicate identifiers are renamed to match
...
-   Fix [a bug](https://redirect.github.com/dart-lang/native/issues/1967) where blocking
...
# Discussion History
# Action History
- Created by: renovate[bot] | 2025-03-11T06:53:22+00:00
- Merged at: 2025-03-17T12:23:30+00:00
