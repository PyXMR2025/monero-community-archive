...
updated_at: '2026-08-24T17:42:40+00:00'
type: pull_request
status: open
closed_at: null
merged_at: null
...
# Discussion History
## selsta | 2026-08-24T17:33:53+00:00
```suggestion
    const bool is_rct = in.mask != rct::I;
```

## selsta | 2026-08-24T17:40:28+00:00
HF15 tx needs two outputs

## selsta | 2026-08-24T17:42:27+00:00
```suggestion
    const size_t mixin = sweep_unmixable_override ? 0 : 15;
```

otherwise it can't create unmixable sweep.
