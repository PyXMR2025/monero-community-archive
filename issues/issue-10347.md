---
title: '[Feature Request] Design a strict C-ABI / Cgo-friendly wrapper for wallet3
  to facilitate Go/Rust backend integrations'
source_url: https://github.com/monero-project/monero/issues/10347
author: ChrisLattner03
assignees: []
labels:
- proposal
created_at: '2026-03-05T07:37:53+00:00'
updated_at: '2026-03-05T21:02:41+00:00'
type: issue
status: open
closed_at: null
---
...
# Discussion History
## vtnerd | 2026-03-05T17:07:27+00:00
There is a [C wrapper](https://github.com/mrcyjanek/monero_c) around the wallet API. It's a bit clunky, but very functional. Cake wallet uses this wrapper, so it's fairly well maintained. Comes with bindings for Dart, Typescript, and C#.

I also [maintain a fork](https://github.com/vtnerd/monero_c/tree/lwsf) for light-wallets. In use by skylight wallet. The majority (99%) of the glue code is the same because everything uses virtual functions that can be swapped out.

If you need something beyond Wallets, it doesn't exist afaik. Updating "wallet3" to support C in this repo would be nice, but there is already an effort to get `monero-wallet-cli` and `monero-wallet-rpc` to use the C++ API instead of the internal interface it uses now.

# Action History
- Created by: ChrisLattner03 | 2026-03-05T07:37:53+00:00
