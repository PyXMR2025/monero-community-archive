---
title: Fluorine Fermi, GUI, Point Release 1.1
type: release
source_url: https://github.com/monero-project/monero-gui/releases/tag/v0.18.1.1
author: binaryFate
tag_name: v0.18.1.1
published_at: '2022-09-19T22:19:29+00:00'
---
...
[The latest CLI release notes can be found on the precedent blog post](https://www.getmonero.org/2022/09/19/monero-0.18.1.1-released.html)
...
Two guides are available to guide you through the verification process: [Verify binaries on Windows (beginner)](https://www.getmonero.org/resources/user-guides/verification-windows-beginner.html) and [Verify binaries on Linux, Mac, or Windows command line (advanced)](https://www.getmonero.org/resources/user-guides/verification-allos-advanced.html).