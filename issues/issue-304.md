---
title: 'Research meeting: 4 February 2019 @ 17:00 UTC'
source_url: https://github.com/monero-project/meta/issues/304
author: SarangNoether
assignees: []
labels: []
created_at: '2019-02-04T13:57:41+00:00'
updated_at: '2019-02-13T14:21:02+00:00'
type: issue
status: closed
closed_at: '2019-02-04T18:09:59+00:00'
---

# Original Description
Join in for the weekly Monero Research Lab meeting.

**When**: Monday, 4 February 2019 @ 17:00 UTC
**Where**: #monero-research-lab (freenode/matrix)

**Agenda**
1. Greetings

2. Network upgrade review
a. [Payment ID schedule](https://github.com/monero-project/meta/issues/299)
b. Block size algorithm testing: [PR 5124](https://github.com/monero-project/monero/pull/5124/files)
c. Output selection options

3. Other work
a. Sarang: security proofs, [Bulletproofs](https://crypto.stanford.edu/bulletproofs/) MPC, [Ristretto](https://ristretto.group/), [deterministic output selection](https://isi.jhu.edu/~mgreen/mixing.pdf), [Dandelion routing](https://arxiv.org/abs/1805.11060)
b. Surae: matching simulations, output selection, security proofs
c. Others?
...
# Discussion History
## b-g-goodell | 2019-02-04T16:05:31+00:00
I'll be chatting about matching simulations in a bit of detail... as well as adding comments to Sarang's discussion, especially with regards to output selection and securtiy proofs.

## SarangNoether | 2019-02-13T14:21:02+00:00
    ...
    [2019-02-04 11:59:51] <sarang> a special ping to moneromooo as well, since he has a PR that I wish to discuss
    ...
    [2019-02-04 12:00:54] → thrmo joined (~thrmo@unaffiliated/thrmo)
    [2019-02-04 12:00:54] → Mochi101 joined (~Mochi101@unaffiliated/mochi101)
    ...
    [2019-02-04 12:01:15] <sarang> I don't want to discuss opinions on that at this meeting, only to remind of what the timeline has been
    [2019-02-04 12:01:26] <needmoney90> Hey!
    [2019-02-04 12:01:31] <sarang> Of more pressing interest is the block size algorithm
    [2019-02-04 12:01:47] <Mochi101> You guys going to introduce more tools for sub-addresses too?
    [2019-02-04 12:01:49] * [-mugatu-] → IRS
    ...
    [2019-02-04 12:03:09] ⇐ thrmo quit (~thrmo@unaffiliated/thrmo): Client Quit
    [2019-02-04 12:03:11] <sarang> The PR contains moneromooo's implementation of the latter
    [2019-02-04 12:03:28] → thrmo joined (~thrmo@unaffiliated/thrmo)
    [2019-02-04 12:03:34] <ArticMine> Actually There were 3 option for block weight scaling
    [2019-02-04 12:03:53] <ArticMine> That were formalized
    ...
    [2019-02-04 12:06:36] <ArticMine> In the first option the full blockweight including the burst portion was used to scale the long term median
    ...
    [2019-02-04 12:07:56] → dgoddard joined (~Denis@2601:186:280:4c0:eade:27ff:fe14:1fb7)
    ...
    [2019-02-04 12:12:10] ← Mochi101 left (~Mochi101@unaffiliated/mochi101): "Leaving"
    [2019-02-04 12:12:36] <sarang> ArticMine: does moneromooo's code accurately reflect your proposal?
    [2019-02-04 12:12:40] <sarang> And does my Python code?
    ...
    [2019-02-04 12:13:48] <moneromooo> The python code I saw from... sarang I assume, can't recall now :) and my code agreed on the results when pushing blocks with the max allowed weight.
    ...
    [2019-02-04 12:14:13] <sarang> and that spiked the total cost
    ...
    [2019-02-04 12:14:49] ⇐ mistergold quit (~mistergol@77.243.31.254): Read error: Connection reset by peer
    [2019-02-04 12:15:03] <sarang> Let's assume we are all talking about this paste: http://paste.debian.net/hidden/292e473f/
    [2019-02-04 12:15:10] <sarang> Note line 56 please
    [2019-02-04 12:15:26] <Xeagu> Whatever is implemented should have a clear way to explain to the rest of the ecosystem.
    ...
    [2019-02-04 12:16:06] <sarang> *clear on this
    [2019-02-04 12:16:36] <sarang> So my current questions are: ArticMine is this your intention? moneromooo is the current paste (not the commented-out line) what is in the PR?
    ...
    [2019-02-04 12:17:38] <sarang> ArticMine: what about the difference between lines 56 and 57?
    ...
    [2019-02-04 12:21:59] ⇐ cardboardoranges quit (~cardboard@65.112.8.10): Quit: cardboardoranges
    ...
    [2019-02-04 12:22:30] <oneiric_> is there any indication that 160GB is near?
    ...
    [2019-02-04 12:23:25] <Xeagu> Do we have simulations of upper bound organic growth in x time? Say Monero gets added to Open Bazaar or something - what is the realistic transaction growth we might expect?
    ...
    [2019-02-04 12:24:52] <suraeNoether> ArticMine: in order to pull off a 51% attack, i need i) the money and ii) some miners willing to take my bribe at the cost of the value of their xmr
    ...
    [2019-02-04 12:25:41] <Xeagu> One is permissionless
    [2019-02-04 12:25:50] <ArticMine> So it the other
    [2019-02-04 12:25:56] <ArticMine> is
    [2019-02-04 12:26:00] <suraeNoether> ArticMine: nah, you need to go find miners to work with
    ...
    [2019-02-04 12:26:36] <suraeNoether> anyway
    ...
    [2019-02-04 12:27:57] <suraeNoether> articmine: tweaking R and N can not destroy a critical component of monero
    ...
    [2019-02-04 12:31:26] <sarang> ty ArticMine. In particular: please try switching between lines 56 and 57 and note the cost change
    ...
    [2019-02-04 12:32:16] <Xeagu> If we implement ArticMine's change, can we also come up with a ELI5 explanation of what is going on?
    ...
    [2019-02-04 12:32:24] <moneromooo> Oh OK. I did not do anything with fee with my code.
    ...
    [2019-02-04 12:34:51] <sarang> thank you
    [2019-02-04 12:35:00] <sarang> note to moneromooo ^
    [2019-02-04 12:35:12] <moneromooo> who still does not think it works
    [2019-02-04 12:35:36] <sarang> At least we agree on the final bloat and blocksize :/
    ...
    [2019-02-04 12:36:50] <Xeagu> Fwiw none of these measures seem to prevent slower bloat with min fee txs flooding the mempool and eventually getting confirmed over time
    ...
    [2019-02-04 12:37:47] <sarang> The idea being to weight block selection for ring decoys by the number of outputs, consistent with our gamma spend distribution
    ...
    [2019-02-04 12:40:11] <Xeagu> Input age heuristic for multi ring transactions is an interesting consideration
    [2019-02-04 12:40:20] <Inge-> 18:25 < ArticMine> is
    [2019-02-04 12:40:41] <sarang> IMO we should iteratively first focus on removing some of the selection bias, and then later move to address other multi-in heuristics
    ...
    [2019-02-04 12:43:22] <suraeNoether> ^
    ...
    [2019-02-04 12:45:06] <sarang> moneromooo: this assumes you're recalculating the product (this block's gamma factor)*(this block's weight) for each block, every time a new block arrives?
    ...
    [2019-02-04 12:45:43] <sarang> got it
    ...
    [2019-02-04 12:47:24] <sarang> Yes we do
    ...
    [2019-02-04 12:48:19] <sarang> having to do with the mempool
    ...
    [2019-02-04 12:49:12] <sarang> Any specific questions for me regarding my agenda-listed items?
    ...
    [2019-02-04 12:51:16] <moneromooo> Yes.
    ...
    [2019-02-04 12:52:30] <sarang> OK, suraeNoether ?
    [2019-02-04 12:52:33] <sarang> your updates?
    [2019-02-04 12:53:19] → cardboardoranges joined (~cardboard@65.112.8.10)
    ...
    [2019-02-04 12:54:02] <suraeNoether> basically: i'm assuming blocks arrive one at a time linearly for the sake of simplicity, i assume transaction density in each block is poisson distributed, and i assume each transaction is M-in, N-out according to some distribution I haven't selected yet (but will probably be empirical from our blockchain)
    ...
    [2019-02-04 12:55:14] <sarang> define plz
    ...
    [2019-02-04 12:56:07] <sarang> sweet
    ...
    [2019-02-04 12:57:12] → Cryptonic joined (~cryptonic@49.151.16.156)
    ...
    [2019-02-04 12:58:02] <sarang> Awesome, please keep us updated on the sim results. This will be very useful to those needing to churn safely
    ...
    [2019-02-04 12:58:58] <suraeNoether> xeagu trying to formalize "how much should you churn for the following security level"
    ...
    [2019-02-04 12:59:16] <sarang> Anything else you're working on?
    ...
    [2019-02-04 13:00:35] ⇐ cardboardoranges quit (~cardboard@65.112.8.10): Quit: cardboardoranges
    [2019-02-04 13:00:41] <sarang> our old friend Liu
    [2019-02-04 13:00:53] → tazman joined (~g0d@37.139.3.113)
    ...
    [2019-02-04 13:02:04] ⇐ Cryptonic quit (~cryptonic@49.151.16.156): Ping timeout: 250 seconds
    ...
    [2019-02-04 13:02:29] <sarang> they can donate via mfs
    [2019-02-04 13:02:34] → Febo joined (Febo@89-212-17-205.static.t-2.net)
    ...
    [2019-02-04 13:03:01] <sarang> Nice. I'm not opposed to it as another option
    ...
    [2019-02-04 13:05:39] * tazman → godzila
...
# Action History
- Created by: SarangNoether | 2019-02-04T13:57:41+00:00
- Closed at: 2019-02-04T18:09:59+00:00
