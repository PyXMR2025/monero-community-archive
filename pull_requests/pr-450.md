...
updated_at: '2026-09-09T20:25:55+00:00'
type: pull_request
status: merged
closed_at: '2026-09-09T20:25:55+00:00'
merged_at: '2026-09-09T20:25:55+00:00'
---
...
# Discussion History
## Boog900 | 2026-08-11T23:20:25+00:00
I think this needs the arg to ignore the limit that's on the PR here: https://github.com/monero-project/monero/pull/11065



## j-berman | 2026-08-11T23:40:00+00:00
Yep yep, I'm just going to cherry-pick that change and build on top of it

## Boog900 | 2026-08-31T15:02:48+00:00
...
## j-berman | 2026-09-04T01:06:56+00:00
It's technically possible for some requests to get removed in that specific spot in some narrow circumstances (and IIRC does sometimes hit observed in logs).

Example:
Node A requests the tx hash from Node B.
Block containing the tx hash enters Node A's chain.
Before the request can get removed from Node A's queue in L1738, Node C hits us with a notify of the tx hash.

It's also possible for the block to be missing some txs from the block and for it to take a bit before L1738 can execute.

I think it's more just a sane cheap thing to have there, even though it's not really usually expected to do much. I can remove that comment, or add some of this context for why?

## Boog900 | 2026-09-08T14:13:50+00:00
Ah fair yeah, I think this is fine here then. That comment is a little confusing if it is hit in normal usage IMO 

## j-berman | 2026-09-09T05:37:22+00:00
@selsta also pointed out `fly_available_requests_in_queue` can actually do hundreds of iterations when connected to a lot of peers, so it's not thaaaat cheap.

In the latest I actually check if any requests get removed from the tx request queue before calling `fly_available_requests_in_queue`, just to avoid really over-calling it when it's obviously unnecessary to do so.

I also updated that comment.

I don't anticipate further changes to this PR

# Action History
- Created by: j-berman | 2026-08-03T16:24:31+00:00
- Merged at: 2026-09-09T20:25:55+00:00
