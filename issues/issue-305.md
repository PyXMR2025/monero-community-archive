---
title: Research meeting 11 February 2019 @ 17:00 UTC
source_url: https://github.com/monero-project/meta/issues/305
author: SarangNoether
assignees: []
labels: []
created_at: '2019-02-11T14:41:44+00:00'
updated_at: '2019-02-13T14:21:30+00:00'
type: issue
status: closed
closed_at: '2019-02-11T17:51:51+00:00'
---

# Original Description
Join in for the weekly Monero Research Lab meeting.

**When**: Monday, 11 February 2019 @ 17:00 UTC
**Where**: #monero-research-lab (freenode/matrix)

**Agenda**
1. Greetings

2. Network upgrade (new schedule, who dis)

3. Other work
a. Sarang: timing analysis, output selection, Breaking Monero
b. Surae
c. Others?
...
# Discussion History
## SarangNoether | 2019-02-13T14:21:30+00:00
    ...
    [2019-02-11 12:00:13] <sarang> I have not been able to follow the last couple of days' updates (was involved in an accident) but much has happened
    ...
    [2019-02-11 12:01:01] <sarang> There is not currently a good central resource for what exactly is changing
    ...
    [2019-02-11 12:03:31] <moneromooo> Because people did not want two forks.
    ...
    [2019-02-11 12:05:37] <sarang> moneromooo: is there a timeline estimate for when those will go in?
    ...
    [2019-02-11 12:10:07] <sarang> but an earlier draft of it was incorrect
    ...
    [2019-02-11 12:12:00] <Xeagu> Ability to spend unmixable outputs? What does this mean?
    [2019-02-11 12:12:06] <sarang> I presume we can/should point affected parties to -dev for more details
    [2019-02-11 12:12:20] <sarang> I believe this only affects certain pre-CT outputs
    ...
    [2019-02-11 12:14:25] <sarang> suraeNoether: can you give the gist of your question at least?
    [2019-02-11 12:14:27] <moneromooo> Those patches are also all in master.
    [2019-02-11 12:14:30] <sarang> Unless it isn't relevant to the group
    ...
    [2019-02-11 12:15:12] <sarang> oh ok
    ...
    [2019-02-11 12:17:44] <learninandlurkin> sarang: eventually I will actually drop a nice contribution, if all goes to plan... (forever lurking and learning though)
    ...
    [2019-02-11 12:20:01] <sarang> If we used the entire window, it smooths the selection process much more
    [2019-02-11 12:20:06] <suraeNoether> smooth: let's carry hold on that conversation until after the meeting. block size conversations are a black hole and we want to get to other things
    ...
    [2019-02-11 12:20:59] <sarang> Any questions from me, before suraeNoether shares?
    [2019-02-11 12:21:13] <suraeNoether> sarang why use a windowing method instead of a precise selection method like the one I presented last week? simpler to implement given our current code?
    ...
    [2019-02-11 12:21:28] <sarang> I'm not saying that I favor the full-window method as optimal
    ...
    [2019-02-11 12:23:40] → rottensox joined (~rottensox@unaffiliated/rottensox)
    ...
    [2019-02-11 12:25:04] → dgoddard joined (~Denis@2601:186:280:4c0:eade:27ff:fe14:1fb7)
    ...
    [2019-02-11 12:27:49] <sarang> Keep in mind that we generally cannot repost final journal copies of any papers
    ...
    [2019-02-11 12:29:32] <sarang> Any other recent research to share from anyone?
    ...
    [2019-02-11 12:32:38] <sarang> YES
    ...
    [2019-02-11 12:34:29] <sarang> The proofs are also interesting for our current signatures, it seems
    ...
    [2019-02-11 12:39:40] <sarang> That sounds reasonable
    ...
    [2019-02-11 12:41:15] <sarang> It changes the incentives, economics, and structure of attacks, often in subtle and tricky ways
    ...
    [2019-02-11 12:44:00] <moneromooo> Can you speed up BPs some more ?
    ...
    [2019-02-11 12:44:44] <sarang> Feel free to continue discussion, but we are now adjourned
    [2019-02-11 12:44:57] <oneiric_> \./


# Action History
- Created by: SarangNoether | 2019-02-11T14:41:44+00:00
- Closed at: 2019-02-11T17:51:51+00:00
