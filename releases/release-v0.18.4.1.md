---
title: ' Fluorine Fermi, Point Release 4.1'
type: release
source_url: https://github.com/monero-project/monero/releases/tag/v0.18.4.1
author: binaryFate
tag_name: v0.18.4.1
published_at: '2025-07-25T18:35:49+00:00'
---
...
- Wallet: fix stale multisig data after failed refresh (#9911)
- Wallet: fix a bug when changing password (#9945)
- Wallet: apply subaddress lookahead changes immediately (#9954)
- Wallet respect `do-not-relay` in `sweep_single` (#9978)
- Daemon: improve logic when connecting to a peer (#9949)
- Daemon: add new dynamic fees to ZMQ (#9958)
- RPC: fix edge case causing unresponsive wallet (#9950)
- RPC: add `set_subaddresss_lookahead` endpoint (#9954)
- Add safeguard for rare exception in TCP accept handler (#9956)
