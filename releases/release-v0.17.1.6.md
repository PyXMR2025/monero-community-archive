---
title: Oxygen Orion, GUI, Point Release 1.6
type: release
source_url: https://github.com/monero-project/monero-gui/releases/tag/v0.17.1.6
author: binaryFate
tag_name: v0.17.1.6
published_at: '2020-12-08T21:08:22+00:00'
---
...
This is the v0.17.1.6 minor point release of the Monero GUI software.
This is a recommended release that contains P2P network layer improvements.

[The latest CLI release notes can be found on the precedent blog post](https://getmonero.org/2020/12/07/monero-0.17.1.6-released.html)
