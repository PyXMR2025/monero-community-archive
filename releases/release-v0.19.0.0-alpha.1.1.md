---
title: FCMP++ & Carrot alpha stressnet v1.1
type: release
source_url: https://github.com/seraphis-migration/monero/releases/tag/v0.19.0.0-alpha.1.1
author: j-berman
tag_name: v0.19.0.0-alpha.1.1
published_at: '2025-10-02T01:47:10+00:00'
---

# Version: v0.19.0.0-alpha.1.1
...
- `transfer` and `sweep` commands in the CLI wallet before the FCMP++ fork (#123)
- Debug build sync after the FCMP++ hard fork (#125)
- `version` command in the daemon (#126)
